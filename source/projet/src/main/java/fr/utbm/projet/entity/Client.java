 ...
 * </p>
 * <p>
 * De plus un Client peut etre inscrit a une session de une seul UV (courseSession)
 * </p>
 * 
 * @see CourseSession
 * @see Client.hbm.xml
...
public class Client {
 /**
         * L'ID du Client. Cet ID n'est pas modifiable.
    ...
    private CourseSession CoursInscrit;
      ...
      /**
         ...
         *            Le prenom du client
          ...
          *     L'email du client
         * @param CoursInscrit 
         *          Le cours dans lesquel notre client c'est inscrit
